...
void main() {
	...
	`}class Eu extends Ri{constructor(t=1,e={}){super(t,t,e),this.isWebGLCubeRenderTarget=!0;const n={width:t,height:t,depth:1},s=[n,n,n,n,n,n];this.texture=new _u(s),this._setTextureOptions(e),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,e){this.texture.type=e.type,this.texture.colorSpace=e.colorSpace,this.texture.generateMipmaps=e.generateMipmaps,this.texture.minFilter=e.minFilter,this.texture.magFilter=e.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new Qs(5,5,5),a=new Li({name:"CubemapFromEquirect",uniforms:Ms(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Je,blending:zi});a.uniforms.tEquirect.value=e;const r=new ui(s,a),o=e.minFilter;return e.minFilter===An&&(e.minFilter=Ge),new ep(1,10,this).update(t,r),e.minFilter=o,r.geometry.dispose(),r.material.dispose(),this}clear(t,e=!0,n=!0,s=!0){const a=t.getRenderTarget();for(let r=0;r<6;r++)t.setRenderTarget(this,r),t.clear(e,n,s);t.setRenderTarget(a)}}function Qm(i){let t=new WeakMap,e=new WeakMap,n=null;function s(c,f=!1){return c==null?null:f?r(c):a(c)}function a(c){if(c&&c.isTexture){const f=c.mapping;if(f===Pr||f===Rr)if(t.has(c)){const _=t.get(c).texture;return o(_,c.mapping)}else{const _=c.image;if(_&&_.height>0){const M=new Eu(_.height);return M.fromEquirectangularTexture(i,c),t.set(c,M),c.addEventListener("dispose",h),o(M.texture,c.mapping)}else return null}}return c}function r(c){if(c&&c.isTexture){const f=c.mapping,_=f===Pr||f===Rr,M=f===Rn||f===gs;if(_||M){let m=e.get(c);const p=m!==void 0?m.texture.pmremVersion:0;if(c.isRenderTargetTexture&&c.pmremVersion!==p)return n===null&&(n=new Yh(i)),m=_?n.fromEquirectangular(c,m):n.fromCubemap(c,m),m.texture.pmremVersion=c.pmremVersion,e.set(c,m),m.texture;if(m!==void 0)return m.texture;{const b=c.image;return _&&b&&b.height>0||M&&b&&l(b)?(n===null&&(n=new Yh(i)),m=_?n.fromEquirectangular(c):n.fromCubemap(c),m.texture.pmremVersion=c.pmremVersion,e.set(c,m),c.addEventListener("dispose",d),m.texture):null}}}return c}function o(c,f){return f===Pr?c.mapping=Rn:f===Rr&&(c.mapping=gs),c}function l(c){let f=0;const _=6;for(let M=0;M<_;M++)c[M]!==void 0&&f++;return f===_}function h(c){const f=c.target;f.removeEventListener("dispose",h);const _=t.get(f);_!==void 0&&(t.delete(f),_.dispose())}function d(c){const f=c.target;f.removeEventListener("dispose",d);const _=e.get(f);_!==void 0&&(e.delete(f),_.dispose())}function u(){t=new WeakMap,e=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:u}}function jm(i){const t={};function e(n){if(t[n]!==void 0)return t[n];const s=i.getExtension(n);return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&us("WebGLRenderer: "+n+" extension not supported."),s}}}function t_(i,t,e,n){const s={},a=new WeakMap;function r(u){const c=u.target;c.index!==null&&t.remove(c.index);for(const _ in c.attributes)t.remove(c.attributes[_]);c.removeEventListener("dispose",r),delete s[c.id];const f=a.get(c);f&&(t.remove(f),a.delete(c)),n.releaseStatesOfGeometry(c),c.isInstancedBufferGeometry===!0&&delete c._maxInstanceCount,e.memory.geometries--}function o(u,c){return s[c.id]===!0||(c.addEventListener("dispose",r),s[c.id]=!0,e.memory.geometries++),c}function l(u){const c=u.attributes;for(const f in c)t.update(c[f],i.ARRAY_BUFFER)}function h(u){const c=[],f=u.index,_=u.attributes.position;let M=0;if(_===void 0)return;if(f!==null){const b=f.array;M=f.version;for(let A=0,S=b.length;A<S;A+=3){const w=b[A+0],y=b[A+1],P=b[A+2];c.push(w,y,y,P,P,w)}}else{const b=_.array;M=_.version;for(let A=0,S=b.length/3-1;A<S;A+=3){const w=A+0,y=A+1,P=A+2;c.push(w,y,y,P,P,w)}}const m=new(_.count>=65535?fu:uu)(c,1);m.version=M;const p=a.get(u);p&&t.remove(p),a.set(u,m)}function d(u){const c=a.get(u);if(c){const f=u.index;f!==null&&c.version<f.version&&h(u)}else h(u);return a.get(u)}return{get:o,update:l,getWireframeAttribute:d}}function e_(i,t,e){let n;function s(u){n=u}let a,r;function o(u){a=u.type,r=u.bytesPerElement}function l(u,c){i.drawElements(n,c,a,u*r),e.update(c,n,1)}function h(u,c,f){f!==0&&(i.drawElementsInstanced(n,c,a,u*r,f),e.update(c,n,f))}function d(u,c,f){if(f===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,c,0,a,u,0,f);let M=0;for(let m=0;m<f;m++)M+=c[m];e.update(M,n,1)}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=h,this.renderMultiDraw=d}function i_(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(a,r,o){switch(e.calls++,r){case i.TRIANGLES:e.triangles+=o*(a/3);break;case i.LINES:e.lines+=o*(a/2);break;case i.LINE_STRIP:e.lines+=o*(a-1);break;case i.LINE_LOOP:e.lines+=o*a;break;case i.POINTS:e.points+=o*a;break;default:Vt("WebGLInfo: Unknown draw mode:",r);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function n_(i,t,e){const n=new WeakMap,s=new ue;function a(r,o,l){const h=r.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=d!==void 0?d.length:0;let c=n.get(o);if(c===void 0||c.count!==u){let E=function(){P.dispose(),n.delete(o),o.removeEventListener("dispose",E)};c!==void 0&&c.texture.dispose();const f=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,M=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],p=o.morphAttributes.normal||[],b=o.morphAttributes.color||[];let A=0;f===!0&&(A=1),_===!0&&(A=2),M===!0&&(A=3);let S=o.attributes.position.count*A,w=1;S>t.maxTextureSize&&(w=Math.ceil(S/t.maxTextureSize),S=t.maxTextureSize);const y=new Float32Array(S*w*4*u),P=new hu(y,S,w,u);P.type=wi,P.needsUpdate=!0;const v=A*4;for(let C=0;C<u;C++){const R=m[C],D=p[C],H=b[C],q=S*w*4*C;for(let B=0;B<R.count;B++){const X=B*v;f===!0&&(s.fromBufferAttribute(R,B),y[q+X+0]=s.x,y[q+X+1]=s.y,y[q+X+2]=s.z,y[q+X+3]=0),_===!0&&(s.fromBufferAttribute(D,B),y[q+X+4]=s.x,y[q+X+5]=s.y,y[q+X+6]=s.z,y[q+X+7]=0),M===!0&&(s.fromBufferAttribute(H,B),y[q+X+8]=s.x,y[q+X+9]=s.y,y[q+X+10]=s.z,y[q+X+11]=H.itemSize===4?s.w:1)}}c={count:u,texture:P,size:new Rt(S,w)},n.set(o,c),o.addEventListener("dispose",E)}if(r.isInstancedMesh===!0&&r.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",r.morphTexture,e);else{let f=0;for(let M=0;M<h.length;M++)f+=h[M];const _=o.morphTargetsRelative?1:1-f;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",h)}l.getUniforms().setValue(i,"morphTargetsTexture",c.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",c.size)}return{update:a}}function s_(i,t,e,n,s){let a=new WeakMap;function r(h){const d=s.render.frame,u=h.geometry,c=t.get(h,u);if(a.get(c)!==d&&(t.update(c),a.set(c,d)),h.isInstancedMesh&&(h.hasEventListener("dispose",l)===!1&&h.addEventListener("dispose",l),a.get(h)!==d&&(e.update(h.instanceMatrix,i.ARRAY_BUFFER),h.instanceColor!==null&&e.update(h.instanceColor,i.ARRAY_BUFFER),a.set(h,d))),h.isSkinnedMesh){const f=h.skeleton;a.get(f)!==d&&(f.update(),a.set(f,d))}return c}function o(){a=new WeakMap}function l(h){const d=h.target;d.removeEventListener("dispose",l),n.releaseStatesOfObject(d),e.remove(d.instanceMatrix),d.instanceColor!==null&&e.remove(d.instanceColor)}return{update:r,dispose:o}}const a_={[Yc]:"LINEAR_TONE_MAPPING",[$c]:"REINHARD_TONE_MAPPING",[Kc]:"CINEON_TONE_MAPPING",[Zc]:"ACES_FILMIC_TONE_MAPPING",[Qc]:"AGX_TONE_MAPPING",[jc]:"NEUTRAL_TONE_MAPPING",[Jc]:"CUSTOM_TONE_MAPPING"};function r_(i,t,e,n,s,a){const r=new Ri(t,e,{type:i,depthBuffer:s,stencilBuffer:a,samples:n?4:0,depthTexture:s?new vs(t,e):void 0}),o=new Ri(t,e,{type:Xi,depthBuffer:!1,stencilBuffer:!1}),l=new Xe;l.setAttribute("position",new We([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new We([0,2,0,0,2,0],2));const h=new Yd({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
#define LOW_PRECISION`),t}const dg={[Ga]:"SHADOWMAP_TYPE_PCF",[Ns]:"SHADOWMAP_TYPE_VSM"};function pg(i){return dg[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const mg={[Rn]:"ENVMAP_TYPE_CUBE",[gs]:"ENVMAP_TYPE_CUBE",[_r]:"ENVMAP_TYPE_CUBE_UV"};function _g(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":mg[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const gg={[gs]:"ENVMAP_MODE_REFRACTION"};function vg(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":gg[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Mg={[qc]:"ENVMAP_BLENDING_MULTIPLY",[Qf]:"ENVMAP_BLENDING_MIX",[jf]:"ENVMAP_BLENDING_ADD"};function xg(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Mg[i.combine]||"ENVMAP_BLENDING_NONE"}function Sg(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function yg(i,t,e,n){const s=i.getContext(),a=e.defines;let r=e.vertexShader,o=e.fragmentShader;const l=pg(e),h=_g(e),d=vg(e),u=xg(e),c=Sg(e),f=ag(e),_=rg(a),M=s.createProgram();let m,p,b=e.glslVersion?"#version "+e.glslVersion+`
