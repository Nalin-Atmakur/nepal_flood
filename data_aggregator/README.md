...
├── sources.yaml           the source registry: 60 sources (55 built, 5 registered-unverified), the contract for pull_external_data
...
├── scripts/               health.py (60-s health check) · morning_report.py (make report) · install_schedule.sh (unused: launchd/loop installer, kept for reference)
...
Contact: nepalfloodrescuers@gmail.com (or the site's form, “Agency”).
