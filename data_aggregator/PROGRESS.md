...
## Cycle log
- 06:50 BST — Share text (WhatsApp/X/Telegram) now carries the hook and the ask in en/ne/hi (eeebb63, deployed). About page NE checked at 390 px. Launched T1: translation review of all 416 NE/HI strings for naturalness and consistent terms before distribution.
