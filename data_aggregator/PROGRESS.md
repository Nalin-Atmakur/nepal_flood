...
- 12:35 BST 30 Aug · Corridor pass on the owner's 11:48–11:54 screenshots (D-058): discs = object pads (incl. real bridges) → removed; place pills 1.1 units + **Names** toggle; feed 3–6 rows; physics: taken → carried whole (≤ 6 s, tumbling) → broken → carried on → off the east edge (waterfall spray). 115 unit green; e2e + deploy next.
