...
| Real footage of the day (new, 30 Aug 13:30) | — | Inside the corridor section, directly under its controls: three click-to-play clips + "Have footage?" into the form (docs/18) — the share hook next to the simulation |
