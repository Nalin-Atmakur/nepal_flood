...
export const CATALOGUE: Catalogue[] = [
  C("house", "🏠", "medium", { depth: 0.5, speed: 1.2 }, 2.2, 0.45, [
  ...
  C("lodge", "🏨", "heavy", { depth: 0.7, speed: 1.6 }, 2.2, 0.5, [
  ...
  C("office", "🏢", "heavy", { depth: 0.9, speed: 2.0 }, 2.2, 0.6, [
  ...
  C(
    ...
    0.35,
    [
      { shape: "box", size: [0.9, 0.25, 4.2], at: [0, 1.5, 0], colour: "ink", mass: 0.5 },
      { shape: "box", size: [0.45, 1.6, 0.45], at: [0, 0.8, -1.6], colour: "amber", mass: 0.25 },
      { shape: "box", size: [0.45, 1.6, 0.45], at: [0, 0.8, 1.6], colour: "amber", mass: 0.25 },
    ],
    { spansChannel: true },
  ),
  C("bus", "🚌", "medium", { depth: 0.3, speed: 0.9 }, 2.2, 0.4, [
  ...
  C("jeep", "🚙", "light", { depth: 0.2, speed: 0.6 }, 2.2, 0.32, [
  ...
  C("truck", "🚚", "medium", { depth: 0.4, speed: 1.1 }, 2.2, 0.45, [
  ...
  C("tanker", "🛢️", "medium", { depth: 0.4, speed: 1.0 }, 2.2, 0.45, [
  ...
  C("excavator", "🚜", "heavy", { depth: 0.6, speed: 1.5 }, 2.2, 0.5, [
  ...
  C("camp", "⛺", "light", { depth: 0.1, speed: 0.4 }, 2.2, 0.3, [
  ...
  C("container", "📦", "medium", { depth: 0.35, speed: 1.0 }, 2.2, 0.45, [
  ...
  C("mast", "📡", "anchored", { depth: 0.8, speed: 2.2 }, 2.2, 0.3, [
  ...
  C("boulder", "🪨", "heavy", { depth: 1.2, speed: 3.0 }, 2.2, 0.6, [{ shape: "dodeca", size: [0.9, 0, 0], at: [0, 0.8, 0], colour: "rock", mass: 1 }]),
  C("tree", "🌲", "light", { depth: 0.3, speed: 1.0 }, 2.2, 0.35, [
